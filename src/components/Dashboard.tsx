        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl shadow-md border border-slate-200 dark:border-slate-700">
                    <h3 className="text-xl font-bold mb-4 text-slate-700 dark:text-slate-200">Applications by Sector</h3>
                    <div className="h-80">
                ...
                <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl shadow-md border border-slate-200 dark:border-slate-700">
                    <h3 className="text-xl font-bold mb-4 text-slate-700 dark:text-slate-200">Loan Status Overview</h3>
                     <div className="h-80">
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
                                ...
                                <th className="p-3 font-semibold text-slate-600 dark:text-slate-300">Business Name</th>
                                <th className="p-3 font-semibold text-slate-600 dark:text-slate-300">Amount</th>
                                ...
                                <th className="p-3 font-semibold text-slate-600 dark:text-slate-300">Action</th>
                            </tr>
                        </thead>
                        <tbody>
...
const ApplicantDashboard: React.FC<DashboardProps> = ({ onViewProfile, onStartNewApplication, searchTerm, applicants }) => {
    ...
    return (
        <div className="space-y-6">
            <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl shadow-md border border-slate-200 dark:border-slate-700">
                <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Welcome, {currentUser?.name}!</h2>
                <p className="text-slate-600 dark:text-slate-300">Here's a summary of your loan applications and profile status.</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl shadow-md border border-slate-200 dark:border-slate-700">
                 <div className="flex justify-between items-center mb-4">
                    <h3 className="text-xl font-bold text-slate-700 dark:text-slate-200">My Applications</h3>
