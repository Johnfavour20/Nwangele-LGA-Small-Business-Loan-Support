        ...
        <div className="min-h-screen bg-slate-100 flex items-center justify-center">
            <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-8 sm:p-12">
                    ...
                    <p className="text-slate-600 mb-6">Sign in to access the portal.</p>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 disabled:opacity-50"
                    ...
                    <div className="mt-6">
                        <p className="text-center text-sm font-semibold text-slate-500 mb-3">Quick Access (Demo)</p>
                        <div className="flex flex-col sm:flex-row gap-2">
                           {demoCreds.map(cred => (
                             <button key={cred.role} onClick={() => handleDemoClick(cred.user, cred.pass)} className="flex-1 text-center py-2 px-2 text-xs font-semibold rounded-md bg-slate-200 text-slate-700 hover:bg-slate-300 transition disabled:opacity-50" disabled={isLoading}>
                                 Login as {cred.role}
                             </button>
                           ))}
                        </div>
