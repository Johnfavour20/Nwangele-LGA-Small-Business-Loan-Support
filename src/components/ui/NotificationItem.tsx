...
export const NotificationItem: React.FC<NotificationItemProps> = ({
  ...
  return (
    <a
      href="#"
      onClick={handleClick}
      className={`relative flex items-start gap-4 p-4 transition-colors hover:bg-gray-50 ${
    ...
    >
      ...
      <div className="flex-shrink-0 text-gray-500 w-6 h-6 mt-0.5 ml-2">{iconMap[notification.type]}</div>
